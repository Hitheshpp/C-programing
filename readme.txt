...
The latest version of this user's guide can be found at https://blogs.msdn.microsoft.com/astebner/2008/08/28/net-framework-cleanup-tool-users-guide/.
...
of the .NET Framework from your system:
  ...
  * This tool is designed as a last resort for cases where install, uninstall, repair or patch installation did not 
    ...
    .NET Framework Repair Tool at http://go.microsoft.com/fwlink/?LinkID=246062 and the steps listed in the blog post at 
    https://blogs.msdn.microsoft.com/astebner/2008/03/07/updated-what-to-do-if-other-net-framework-setup-troubleshooting-steps-do-not-help/
    before using this cleanup tool.
  ...
  * This cleanup tool will not remove versions of the .NET Framework that are installed as a part of Windows. The
    blog post at
    ...
    contains a list of what version(s) of the .NET Framework are installed as a part of what versions of Windows.
...
https://msdnshared.blob.core.windows.net/media/2016/10/dotnetfx_cleanup_tool.zip
